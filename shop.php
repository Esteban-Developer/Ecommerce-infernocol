                                    ...
                                    <div class='col-lg-4 col-sm-6'>
                                        <div class='product-item'>
                                            <div class='pi-pic' style='max-height:350px'>
                                                ...
                                                <ul>
                                                    <li class='quick-view'>
                                                        <a href='product.php?product_id=$products_id' style='background:#fe4231;color:white'>
                                                            Ver Detalles
                                                        </a>
                                                    </li>
                                                </ul>
                    ...
                    <div class="row" style="display:flex;justify-content:center; padding:14px">
                        <ul class="pagination">
                            ...
                            if ($total_pages > 1) {
                                echo "
                                <li class='page-item'>
                                    <a class='page-link' href='shop.php?page=1'>Primera</a>
                                </li>
                                ";
                                ...
                                echo "
                                <li class='page-item'>
                                    <a class='page-link' href='shop.php?page=$total_pages'>Última</a>
                                </li>
                                ";
                            }
                            }
